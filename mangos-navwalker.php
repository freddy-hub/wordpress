<?php
class walkernavdesktop extends Walker_Nav_Menu
{
  ...
  public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
  {
    ...
    //<b class="caret"></b> commented out
    $item_output .= (($depth == 0 || 1) && $args->has_children) ? '<span class="fa fa-chevron-down pull-right"></span></a>' : '</a>';
